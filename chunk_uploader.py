...
class Client:
    ...
    def upload_file(self, file_path, file_type, file_arg):
        ...
        headers['Token'] = "dGV4bzEyMztAYVMxMjM0NTY7bWhxd3NyOzIwMTgtMDQtMTEgMDk6NTM6MzUuNTU4Mjkx"
        headers['Filesize'] = str(file_size)
        headers['Projectid'] = ""
        headers['Libraryid'] = "110"
        headers['filesize'] = str(file_size)
        headers['Arguments'] = str(file_arg)
        headers['Filetype'] = str(file_type)
        headers['Description'] = "This is a description"
        headers['location'] = '0, 0, 0'
